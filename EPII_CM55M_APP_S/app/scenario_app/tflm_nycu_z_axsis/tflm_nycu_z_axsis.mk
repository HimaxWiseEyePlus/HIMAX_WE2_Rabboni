...
APPL_DEFINES += -DTFLM_NYCU_Z_AXSIS
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_nycu_z_axsis_S_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/TFLM_nycu_z_axsis_S_only.ld
endif
##
